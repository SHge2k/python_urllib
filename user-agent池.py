...
list=[  {"user-agent":"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.1 (KHTML, like Gecko) Chrome/14.0.835.163 Safari/535.1"},
...
print(request.urlopen(request.Request("http://sina.com.cn",headers=headers)).read().decode("utf-8"))
